...
ssh zt@172.22.145.22 "/tmp/check_port_and_http.sh"'''
        ...
        stage('deploy2') {
          steps {
            ...
            ansibleAdhoc(hosts: '172.22.145.22', become: true, forks: 2, module: 'ping')
          }
        }
